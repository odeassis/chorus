# codex-subagent-orchestration Specification

## Purpose
Define the supported spawning, skill-mounting, context, lifecycle, responsibility-boundary, and regression-verification contract for Chorus subagents in the Codex plugin.
## Requirements
